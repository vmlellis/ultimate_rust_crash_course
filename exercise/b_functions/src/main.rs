...
fn volume(x: i32, y: i32, z: i32) -> i32 {
    // 3a. Implement this function to compute the volume of a rectangular prism given
    // dimensions x, y, and z by multiplying x, y, and z together and returning the result.
    x * y * z
}
